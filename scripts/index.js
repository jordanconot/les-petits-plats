...
function filterRecipesByTag() {
  ...
  // console.log('INGREDIENTS FILTRÉS TAG :', availableIngredients);
  // console.log('APPAREILS FILTRÉS TAG:', availableAppliances);
  // console.log('USTENSILES FILTRÉS TAG:', availableUstensils);
}
